  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div className="mb-32 grid text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-1 lg:text-left">
        <ol>
          <li>
            <h2 className={`mt-3 text-2xl font-semibold`}>1. Terms</h2>
            <p>
              By accessing this Website, accessible from
              https://psyce.radicalheights.se/, you are agreeing to be bound by
          ...
          <li>
            <h2 className={`mt-3 text-2xl font-semibold`}>2. Use License</h2>
            ...
            <ul className={`mb-3 mt-3 ml-10`} Style="list-style-type:circle;">
            ...
            <p>
              This will let PSYCE to terminate upon violations of any of these
          ...
          <li>
            <h2 className={`mt-3 text-2xl font-semibold`}>4. Limitations</h2>
          ...
          <li>
            <h2 className={`mt-3 text-2xl font-semibold`}>6. Links</h2>
          ...
          <li>
            ...
            <p>
              PSYCE may revise these Terms of Use for its Website at any time
          ...
          <li>
            <h2 className={`mt-3 text-2xl font-semibold`}>8. Your Privacy</h2>
          </li>
          <p>Please read our Privacy Policy.</p>
          <li>
            <h2 className={`mt-3 text-2xl font-semibold`}>9. Governing Law</h2>
          </li>
        </ol>
      </div>
